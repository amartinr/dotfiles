...
function __promptline {
  ...
  local y_fg="${wrap}38;5;3${end_wrap}"
  local y_bg="${wrap}48;5;0${end_wrap}"
  local y_sep_fg="${wrap}38;5;0${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
